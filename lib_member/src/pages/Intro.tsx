...
import libraryLogo from 'src/assets/new-york-public-library-logo-vector.png'
...
const Intro = ({ setStep }: IntroProps) => {
  return (
    <Box
      ...
      paddingLeft="100px"
    >
      <img src={libraryLogo} alt="safe logo" height="30px" />

      <Typography variant="h1" fontSize="64px" lineHeight="76px">
        New York Library Membership Portal
      </Typography>

      <Typography variant="body1">
        Thanks to account abstraction -- it's just three easy steps:
      </Typography>
